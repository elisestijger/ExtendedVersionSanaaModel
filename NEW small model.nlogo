...
to go
  ...
  [
    ...
    [
      ...
      [
        if (ambulance? = false) and (infected? = true) and (random 100 < hospital-going-tendency)
        [ hospitalize ]
      ]
    ]
  ]
...
<experiments>
  ...
  <experiment name="Small1" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
      <value value="30"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="travel-tendency">
  ...
  <experiment name="Small2" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="Eindelijk7A" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="eindelijk7B" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="eindelijk7C" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="small3" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="echt7b" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="echt7a" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="hehe7a" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="hehe7b" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="hehe7c" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="small4" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="small5" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="small6B" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="small7A" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="small7B" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="small7C" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="small6A" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="GOED7C?" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>initial-people - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
