...
[
  ...
  when-to-begin-nonIso-tendency    ;; standard compliance per turtle
  died?
  ...
  impactFromIso
  impactFromNotIso
  self-determination ;; intrinsic = 5
  motivational-orientation ; intrinsic = 0, extrinsic = 1
  control ; degree to which they are concerned about pressures from self and others
]
...
to setup-people
  create-turtles initial-people
    [ setxy random-xcor random-ycor
      ...
      set age random 36500
      set male? false
      set smoker? false
      set survive? true
      set died? false
      set changed?Iso true
      set changed?Hos true
      set alreadyIsolated? false
      assign-tendency
      ...
      if (random-float 100 < number-males)
      [  set male? true
         if (random-float 100 < smokers-percentage)
            [set smoker? 1]
      ]

      ;; Each individual has a 1% chance of starting out infected
...
to assign-tendency ;; Turtle procedure
  ...
  set isolation-tendency random-normal average-isolation-tendency average-isolation-tendency
  set hospital-going-tendency random-normal average-hospital-going-tendency average-hospital-going-tendency
  set recovery-time random-normal average-recovery-time average-recovery-time
  set when-to-begin-nonIso-tendency random-normal percentage-when-to-begin-nonIso percentage-when-to-begin-nonIso
  ;plot isolation-tendency
  ...
  if when-to-begin-nonIso-tendency >  percentage-when-to-begin-nonIso * 2 [ set when-to-begin-nonIso-tendency percentage-when-to-begin-nonIso * 2 ]
  if when-to-begin-nonIso-tendency < 0 [ set when-to-begin-nonIso-tendency 0 ]
end
...
to go
 ...
 ask turtles
  [compute-peer-pressure]

  ask turtles
  [ if not isolated? and not hospitalized? and infected? and (random 100 < isolation-tendency) and changed?Iso
    [isolate ]]

   ask turtles
    [ if not isolated? and not hospitalized? and infected? and (random 100 < hospital-going-tendency) and changed?Hos
     [hospitalize]]
  ...
  [
    ...
    [
      ...
      [
        if (ambulance? = false) and (infected? = true) and (random 100 < hospital-going-tendency)and changed?Hos
        [ hospitalize ]
      ]
    ]
  ]
...
to group-determiniation
  ask turtles
  [ifelse random-float 1 < Percent-extrinsic; 0 = extrinsic or 1 = intrinsic
    [set motivational-orientation 0 set control random-float 4 + 1.5]
    [set motivational-orientation 1 set control random-float 1.5 + 0.01]]
    ; if intrinsic, should be less likely to perceive peer pressure, therefore control
    ; is less: they are less externally controlled


  ask turtles
 [ ifelse gradient
 [ifelse motivational-orientation = 0
    [set self-determination random 5 set color scale-color magenta self-determination 0 5]
  ; the darkest, black, coloured agents belong to magenta
    [set self-determination random 5 set color scale-color yellow self-determination 5 0]]
 ; the lightest, white, agents belong to white
 [ifelse motivational-orientation = 0
     [set self-determination random-float 5 set color magenta ]
    [set self-determination random-float 5 set color yellow ] ]

 ]

end

to  compute-peer-pressure

  let impactIso 0
  let impactNonIso 0


  let TurtlesNotAlreadyIso count turtles with [alreadyIsolated? = false]
  let TurtlesAlreadyIso count turtles with [alreadyIsolated? = true]

  set impactIso sqrt (sum [impact myself] of (turtles-on neighbors) with [alreadyIsolated? = true])
  set impactNonIso sqrt (sum [impact myself] of (turtles-on neighbors) with [alreadyIsolated? = false])


   if (impactIso > impactNonIso)
  [set changed?Iso true set changed?Hos true]
  if (impactNonIso > impactIso and TurtlesAlreadyIso / TurtlesNotAlreadyIso > when-to-begin-nonIso-tendency )
  [set changed?Iso false set changed?Hos false]
  ...
  to-report impact [otherTurtle]
    let d 0
    set d distance otherTurtle
    if (d = 0) [set d control]


    let finalAnswer (self-determination / (exp ((ln d) * 2))) ^ 2
    report finalAnswer
...
to maybe-recover
 ...
 ifelse not hospitalized?
  ...
  ;;;; age based fatality
   if age > 0 and age < 3285  ;;;; if child
  [
  ...
  if age > 3286 and age < 14235 or male? or smoker?;;;;;; if adult
  [
    if (random-float 100 < 0.020)
        [set died? true
          die
          set death (death + 1)
    ]
  ]
  if age > 14236 and age < 21535 or male? or smoker?;;; old
  [
    if (random-float 100 < 0.0850)
        [set died? true
          die
          set death (death + 1)
    ]
  ]
  if age > 21536 and age < 36500 or male? or smoker?;;;; elder
  [
    if (random-float 100 < 1.65)
        [set died? true
          die
          set death (death  + 1)
    ]
...
;;    ask turtles-on neighbors
;;[ if any? turtles with [alreadyIsolated?]
 ;;  [ move-to patch-here ;; move to center of patch
   ;;   ask (patch-at 0 0) [ set pcolor gray - 3 ]]
  ;;]
end
...
"Recovered" 1.0 0 -14730904 true "" "plot count turtles with [ cured? ]"
...
"" ""
PENS
"default" 1.0 0 -12345184 true "" "histogram [hospital-going-tendency] of turtles"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "histogram [isolation-tendency] of turtles"
...
607
53
percentage-when-to-begin-nonIso
percentage-when-to-begin-nonIso
0
1
0.5
...
515
NIL
count turtles with [alreadyIsolated?]
17
1
11
...
@#$#@#$#@
<experiments>
  <experiment name="1OldScenario1" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="travel-tendency">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number-males">
      <value value="0"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="initial-ambulance">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="1OldScenario4" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="1OldScenario5" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="1OldExperiment6B" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="1OldScenario2" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="1OldScenario3" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="1OldScenario7A" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="1OldScenario7B" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="1OldScenario7C" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="1OldScenario6A" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall1" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall2" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall3" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall4" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall5" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall6B" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall7A" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall7B" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall7C" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
  ...
  <experiment name="2NewSmall6A" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>1000 - count turtles</metric>
    <enumeratedValueSet variable="smokers-percentage">
